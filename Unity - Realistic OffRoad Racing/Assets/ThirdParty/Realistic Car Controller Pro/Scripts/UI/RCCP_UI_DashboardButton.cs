    ...
    private void CheckImage() {
        ...
        switch (buttonType) {
            ...
            case ButtonType.ABS:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.ABS);
            ...
            case ButtonType.ESP:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.ESP);
            ...
            case ButtonType.TCS:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.TCS);

                break;

            case ButtonType.Headlights:

                if (RCCSceneManager.activePlayerVehicle.Lights)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Lights.lowBeamHeadlights);
            ...
            case ButtonType.SteeringHelper:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.steeringHelper);
            ...
            case ButtonType.TractionHelper:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.tractionHelper);
            ...
            case ButtonType.AngularDragHelper:
                ...
                if (RCCSceneManager.activePlayerVehicle.Stability)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Stability.angularDragHelper);
            ...
            case ButtonType.TrailAttachDetach:
                ...
                if (RCCSceneManager.activePlayerVehicle.OtherAddonsManager && RCCSceneManager.activePlayerVehicle.OtherAddonsManager.TrailAttacher) {

                    if (RCCSceneManager.activePlayerVehicle.OtherAddonsManager.TrailAttacher.attachedTrailer != null)
                        RCCSceneManager.activePlayerVehicle.OtherAddonsManager.TrailAttacher.attachedTrailer.DetachTrailer();
            ...
            case ButtonType.GearToggleAutomatic:
                ...
                if (RCCSceneManager.activePlayerVehicle.Gearbox)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Gearbox.transmissionType == RCCP_Gearbox.TransmissionType.Automatic ? true : false);
            ...
            case ButtonType.GearToggleDNRP:
                ...
                if (RCCSceneManager.activePlayerVehicle.Gearbox)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Gearbox.transmissionType == RCCP_Gearbox.TransmissionType.Automatic_DNRP ? true : false);
            ...
            case ButtonType.GearToggleManual:
                ...
                if (RCCSceneManager.activePlayerVehicle.Gearbox)
                    imageOn.SetActive(RCCSceneManager.activePlayerVehicle.Gearbox.transmissionType == RCCP_Gearbox.TransmissionType.Manual ? true : false);
