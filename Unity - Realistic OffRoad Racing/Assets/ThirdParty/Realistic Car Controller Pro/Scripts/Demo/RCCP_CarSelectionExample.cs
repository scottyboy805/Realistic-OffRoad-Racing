...
public class RCCP_CarSelectionExample : RCCP_GenericComponent {
    ...
    public void SelectVehicle() {
        ...
        if (RCCSceneManager && RCCSceneManager.activePlayerCamera)
            RCCSceneManager.activePlayerCamera.ChangeCamera(RCCP_Camera.CameraMode.TPS);
    ...
    public void DeSelectVehicle() {
        ...
        if (RCCSceneManager && RCCSceneManager.activePlayerCamera) {
            ...
            RCCSceneManager.activePlayerCamera.ChangeCamera(RCCP_Camera.CameraMode.TPS);
            RCCSceneManager.activePlayerCamera.ResetCamera();
